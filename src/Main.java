...
public class Main {
	...
	private static void findAssociation(List<School> listSchools, List<Student> listStudents) {
		 HashMap<Student, HashSet<School>> associationAtNight = new HashMap<Student, HashSet<School>>();
		 for(School schoolIter : listSchools) {
		 ...
		 System.out.println(associationAtNight);
	}
	
	private static void doCeremony() {
